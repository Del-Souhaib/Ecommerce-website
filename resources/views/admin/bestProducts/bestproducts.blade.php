<x-app-layout>
            ...
            <table class="table" style="font-size: 13px">
                ...
                @foreach($bestproducts as $bestproduct)
                    <tr class="align-items-center">
                        ...
                        <td>
                            <button class="btn btn-sm btn-danger delete" bestproductid="{{$bestproduct->id}}">Supprimer</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal fade" id="deleteconfirmation" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <form method="post" action="{{url('admin/deletebestproduct')}}" class="modal-content" style="border-radius: 0">
                @csrf
