...
<div class="container mt-5">
    <div class="row p-6 list">
        <a href="{{url('information')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200" style="text-decoration: none">
            <img src="{{asset('media/icons/user.svg')}}" class="" style="height: 35px" >
            <p class="mb-0 text-center ms-4" style="font-size: 17px;color: #204f8c">Informations</p>
        </a>
        <a href="{{url('adresses')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200" style="text-decoration: none">
        ...
        <a href="{{url('mescommande')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200" style="text-decoration: none">
