        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="container-fluid ">
                <div class="row p-6 list">
                    ...
                    <a href="{{url('admin/clients')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
                    ...
                    <a href="{{url('admin/messages')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
                    ...
                    <a href="{{url('admin/companies')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
                    ...
                    <a href="{{url('admin/bestproducts')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
                    ...
                    <a href="{{url('admin/categories')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
                    ...
                    <a href="{{url('admin/souscategories')}}" class="list-item col-3 mt-3 d-flex justify-content-center align-items-center pt-3 pb-3 bg-white border-b border-gray-200">
