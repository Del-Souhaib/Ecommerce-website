                    ...
                    <div class="col-3 card text-center mb-4 pb-2">
                        ...
                        <div class="d-flex">
                            <button @if($product->product->quantity<=0) disabled="disabled"
                                    @endif class="btn addbutton addbutton1" data-bs-toggle="modal"
                            ...
                            <button @if($product->product->quantity<=0) disabled="disabled"
                                    @endif class="btn addbutton addbutton2" data-bs-toggle="modal"
                                    data-bs-target="#addedtopanesuccess"
        ...
        $('.rapide').click(function () {
            $.ajax({
                ...
                data: {
                    ...
                    if (e.quantity >= 1) {
                        $('.modalproducquantity1').html('<img src="{{asset('media/icons/clock.svg')}}" class="me-2" style="width: 12px">' +
                            'Produit en stock <b>  (' + e.quantity + 'article)</b>')
                        $('.modalproducquantity1').css('color', '#559f45')
                    } else {
